...
def solve(funcs,a=-1,b=1, verbose = False, returnBoundingBoxes = False, exact=False, minBoundingIntervalSize=1e-5):
    ...
    #Solve the Chebyshev polynomial system. This hands back a bounding interval per root, not the
    #roots themselves; the roots are read off the boxes below, once we know which boxes we keep.
